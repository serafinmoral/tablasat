...
#        print (cadena)
        if (cadena[0]!='c'):
            ...
            clausula= list(listaux)
            infor.conjuntoclau.append(clausula)
            

    infor.conjuntoclau.sort(key=  len)

#    print("paso a limpiar")
#    infor.limpiarec(0.0untoc
...
class solveSATBack:    
    ...
    def main(self):
        self.configura = backtracking(self.conjuntoclau,[])
